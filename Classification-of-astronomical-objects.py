...
def main():
    ...
    if "galaxy" in classes and "quasar" in classes:
        ...
        ha = pd.to_numeric(test_fe.get("h_alpha_strength_norm", test_fe.get("h_alpha_strength", 0)),
                           errors="coerce").fillna(0)
        o3 = pd.to_numeric(test_fe.get("oIII_strength_norm", test_fe.get("oIII_strength", 0)), errors="coerce").fillna(
            0)
